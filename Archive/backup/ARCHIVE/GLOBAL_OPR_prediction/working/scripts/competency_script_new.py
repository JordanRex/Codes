...
comp_full = comp_full[['employee_global_id', 'year', 'competency_group', 'competency_group_type_l1', 
                       'mr_pers_year_comp_score_mean', 'mr_pers_compgroup_year_comp_score_mean', 'mr_pers_compgroupl1_year_comp_score_mean']]
...
comp_full.drop(['mr_pers_compgroup_year_comp_score_mean'], axis=1, inplace=True)
...
comp_full.drop(['competency_group', 'competency_group_type_l1', 'mr_pers_compgroupl1_year_comp_score_mean'], axis=1, inplace=True)
comp_full.drop_duplicates(inplace=True, subset=['employee_global_id', 'year'])
